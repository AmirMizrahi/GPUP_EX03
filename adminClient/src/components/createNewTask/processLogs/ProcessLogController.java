package components.createNewTask.processLogs;
...
public class ProcessLogController implements TaskController {
    ...
    void pauseResumeButtonAction(ActionEvent event) {
        ...
        this.createTaskController.informPauseToMainActivateTaskController(pause);
    }
    ...
    void startButtonAction(ActionEvent event) {
        ...
        this.createTaskController.activateTask(consumeWhenFinished);
    }
